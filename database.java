...
public class Database{
	...
	public void addMovie(){
		...
		input.prompt("Enter Movie Title > ");
		input.retrieveText();
		title = input.getInput();
		input.prompt("Enter Actor #1 > ");
		input.retrieveText();
		actor1 = input.getInput();
		input.prompt("Enter Actor #2 > ");
		input.retrieveText();
		...
		database.add(new Movie(title, actor1, actor2, year, runtime, director));
	...
	public void directorSearch(){
		...
		KeyboardInput input = new KeyboardInput();
		input.prompt("Enter Director Name > ");
		input.retrieveText();
		director = input.getInput();
